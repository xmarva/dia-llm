...
RUN git clone https://github.com/xmarva/dia-llm.git
WORKDIR /dia-llm
...
# docker build -t dia-llm .
# docker run -it --rm -p 8888:8888 --gpus all --env-file .env -v C:/Users/User/dia-llm:/dia-llm --entrypoint /bin/bash dia-llm -c "/usr/local/bin/docker-entrypoint.sh && exec /bin/bash"
